                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $result_cs = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='CS' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
                            ...
                            $result_tm = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='TM' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
                            ...
                            $result_st = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='ST' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
                            ...
                            $result_ec = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='EC' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
                            ...
                            $result_me = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='ME' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
                            ...
                            $result_ct = $conn->query("SELECT  *  FROM ele_formation WHERE s_label='$semestre'
                                AND categorie='CT' AND affectation='FCBR' AND cursus_label='$cursus_label';");
                            echo '<td>';
